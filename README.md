# faceSmile-helyluv-sheet

[![Up to Date](https://github.com/ikatyang/emoji-cheat-sheet/workflows/Up%20to%20Date/badge.svg)](https://github.com/ikatyang/emoji-cheat-sheet/actions?query=workflow%3A%22Up+to+Date%22)

This cheat sheet is automatic  generated from [GitHub Smile API](https://api.github.com/smile) and [Unicode Full Smile List](https://unicode.org/emoji/charts/full- smile-list.html).

## Table of Contents

- [Smile & Emotion](#smileys--emotion)
